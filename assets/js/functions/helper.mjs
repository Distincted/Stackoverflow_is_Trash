'use strict'
 ...
 export var formatDollar = function(num) {
	num = parseFloat(num);
//	alert();
...
export	var show_small_img = function(thiss){
...
export var seeImage = function(valor){
...
export var  resMsg = function(id, id_ads,val){
...
export var responder = function(id, id_ads,val){
